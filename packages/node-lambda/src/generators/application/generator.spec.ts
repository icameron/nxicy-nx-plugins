...
describe('app', () => {
  ...
  //     expect(tree.read(`my-node-lambda-application/jest.config.ts`, 'utf-8'))
  //       .toMatchInlineSnapshot(`
  //       "/* eslint-disable */
  //       export default {
  //         displayName: 'my-node-lambda-application',
  ...
  //         coverageDirectory: '../coverage/my-node-lambda-application',
  //       };
  //       "
  //     `);
  //   });
  ...
  //     expect(tree.exists(`my-node-lambda-application/jest.config.js`)).toBeTruthy();
  //     expect(tree.exists('my-node-lambda-application/src/main.js')).toBeTruthy();

  //     const tsConfig = readJson(tree, 'my-node-lambda-application/tsconfig.json');
  //     expect(tsConfig.compilerOptions).toEqual({
  //       allowJs: true,
  //       esModuleInterop: true,
  //     });

  //     const tsConfigApp = readJson(tree, 'my-node-lambda-application/tsconfig.app.json');
  ...
  //       js: true,
  //     } as Schema);
  //     const project = readProjectConfiguration(tree, 'my-node-lambda-application');
  //     const buildTarget = project.targets.build;

  //     expect(buildTarget.options.main).toEqual('my-node-lambda-application/src/main.js');
  //   });
  ...
  //       js: true,
  //     } as Schema);
  //     expect(tree.exists(`my-dir/my-node-lambda-application/jest.config.js`)).toBeTruthy();
  //     expect(tree.exists('my-dir/my-node-lambda-application/src/main.js')).toBeTruthy();
  //   });
  // });
